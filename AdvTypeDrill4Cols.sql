...
Select
	...
	${col2_to_grp}, 
	${col3_to_grp}, 
	${col4_to_grp}) result_rows,
	multiIf(result_rows > 0 and result_rows < pow(2,4)-1, 
					concat('Subtotal',toString(log2(result_rows+1))), 
					result_rows = pow(2,4)-1, 'Total', '    ') pivot,
	${col1_to_grp}, 
	${col2_to_grp}, 
	${col3_to_grp}, 
	${col4_to_grp}
...
--having pivot in ('    ', 'Total', 'Subtotal3')
order by
	result_rows desc,
	--ct desc,
	${col1_to_grp} --desc
...
select
	*,
	...
	${col2_to_grp},
	${col3_to_grp}, 
	${col4_to_grp}) as grpno_1_type,
	row_number() over (partition by (
	pivot,	
	${col1_to_grp}, 
	${col2_to_grp}) order by 
	${col3_to_grp}, 
	${col4_to_grp}) as grpno_2_type,
	row_number() over (partition by (
	pivot,	
	${col1_to_grp}, 
	${col2_to_grp}, 
	${col3_to_grp}) order by 
	${col4_to_grp}) as grpno_3_type
from
	t)
select
	pivot,
...
select *,count() from ${schema}.${table} 
	...
	--and ${col_to_filter3} ${col_to_filter3_condition}
	--and ${col_to_filter4} ${col_to_filter4_condition}
	--and ${5} ${col_to_filter5_condition}
	--and ${col_to_filter6} ${col_to_filter6_condition}
	--and ${col_to_filter7} ${col_to_filter7_condition}
	--and ${col_to_filter8} ${col_to_filter8_condition}
	--and ${col_to_filter9} ${col_to_filter9_condition}
